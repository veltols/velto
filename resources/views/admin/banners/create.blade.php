...
<div class="max-w-2xl mx-auto">
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="text" id="text" value="{{ old('text') }}" placeholder="e.g. Exquisite Craftsmanship" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="button_link" id="button_link" value="{{ old('button_link', route('shop.index')) }}" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', 0) }}" min="0" class="block w-32 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
            </div>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
            ...
            <div class="relative flex gap-x-3">
                <div class="flex h-6 items-center">
                    <input id="is_slider" name="is_slider" type="checkbox" value="1" {{ old('is_slider') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                </div>
