        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md shadow-sm sm:text-sm @error('description') border-red-500 @else border-gray-300 focus:border-black focus:ring-black @enderror">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="number" name="display_order" id="display_order" value="{{ old('display_order', 0) }}" class="mt-1 block w-full rounded-md shadow-sm sm:text-sm @error('display_order') border-red-500 @else border-gray-300 focus:border-black focus:ring-black @enderror">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800">Create Category</button>
                </div>
            </form>
        </div>
    </div>
